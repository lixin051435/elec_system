    ...
    <div class="login-box">
        ...
        <div class="login-main">
         <p style="color: red; font-weight: 900">${requestScope.msg }</p>
			<form action="${pageContext.request.contextPath }/BusinessServlet?op=login&user_type=user" class="layui-form" method="post">
				...
				<div class="layui-form-item">
					...
					<div class="pull-right">
						<input type="submit" value="登录" class="layui-btn layui-btn-primary" lay-submit="" lay-filter="login">
						</input>
					</div>
				</div>
			</form>        
